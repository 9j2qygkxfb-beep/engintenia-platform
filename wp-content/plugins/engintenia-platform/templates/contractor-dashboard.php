...
<div class="eng-dashboard-grid">
    ...
    <div class="eng-card">
        ...
        <ul class="eng-list"><?php foreach ($proposals as $proposal) : ?><li><?php echo esc_html($proposal->post_title); ?> - <?php echo esc_html(get_post_meta($proposal->ID, 'eng_quote', true)); ?></li><?php endforeach; ?></ul>
    </div>
    <div class="eng-card">
        <h3><?php esc_html_e('Notifications', 'engintenia-platform'); ?></h3>
        <ul class="eng-list"><?php foreach ($notifications as $notice) : ?><li><?php echo esc_html($notice['text']); ?> <small>(<?php echo esc_html($notice['date']); ?>)</small></li><?php endforeach; ?></ul>
    </div>
    <div class="eng-card">
